...
|Name<a id="attrtype-name" />                       | restricted Literal    | Unique object names; The allowed characters are listed in [AnnexC](#table-c1) Default value: object type with an index in parent.|

...
| ResistanceY               | [Float](../file-format-definition#attrtype-float )    | The compression ratio for this support along the Y-Axis. Unit N/m. Only for [Ground Supports](../file-format-definition#attrtype-supporttype ).   |
